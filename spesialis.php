...
<body>
	...
	<tr>
		...
		<td>:</td>
		<td><br/>
			<input type="radio" name="dokter[]" value="dr.imam mahdi">dr.muhammad ali <br/>
			<input type="radio" name="dokter[]" value="dr.aisah">dr.supratman <br/>
			<input type="radio" name="dokter[]" value="dr.ahmad ">dr.habibi <br/>
		</td>
		<td>UMUR PASIEN</td>
		<td>:</td>
		<td><br/>
